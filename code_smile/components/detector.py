...
from code_smile.cs_detector.detection_rules.Generic import *
from code_smile.cs_detector.code_extractor.models import load_model_dict, load_tensor_operations_dict
from code_smile.cs_detector.detection_rules.APISpecific import *
from code_smile.cs_detector.code_extractor.dataframe_detector import load_dataframe_dict
from code_smile.cs_detector.detection_rules.Generic import merge_api_parameter_not_explicitly_set
...
def rule_check(node, libraries, filename, df_output,models,output_path):
    ...
    dataframe_path = os.path.join(os.path.dirname(__file__), "../obj_dictionaries/dataframes.csv")
