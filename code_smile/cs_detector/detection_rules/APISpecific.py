...
from code_smile.cs_detector.code_extractor.variables import search_variable_definition
from code_smile.cs_detector.code_extractor.libraries import extract_library_as_name
